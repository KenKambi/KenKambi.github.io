...
Over the years, I’ve worked on diverse engineering projects, from sensor-driven water monitoring device, to group projects like the Automatic Door Alert System (ADAS) and the Elevator Control System simulation, where I worked with microcontrollers, sensors, motors, GSM modules, and PCB fabrication. I’ve also developed several software projects, including [OSM Wrapped](https://osmwrapped.com){target="_blank"}, e-commerce website [Gael Essence](https://kenkambi.github.io/gael/){target="_blank"}, and AI-powered tools such as [ClaudeChef](https://myclaudechef.netlify.app/){target="_blank"}.
