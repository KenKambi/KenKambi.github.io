...
Over the years, I’ve worked on diverse engineering projects, from smart LPG metering systems and sensor-driven water monitoring dashboards to group projects like the Automatic Door Alert System (ADAS) and the Elevator Control System simulation, where I worked with microcontrollers, sensors, motors, GSM modules, and PCB fabrication. I’ve also developed several software projects, including interactive data visualizations, e-commerce websites, and AI-powered tools such as ClaudeChef and OSM Wrapped.
